...
# def check_timer(start_time, time_limit=60):
#     elapsed_time = time() - start_time
#     remaining_time = time_limit - elapsed_time
#     if remaining_time <= 0:
#         print("\nTime's up! You exceeded the 60-second limit. Game over!")
#         exit()
...
# def stage1(start_time):
#     while True:
#         print("Stage 1: Prime Number Selection")
#         remaining_time = check_timer(start_time)  # Check time here
...
#             break
#         else:
#             print("You select wrong e, please select another value e")
...
# def stage4(ciphertext, d, n, start_time):
#     print("\nStage 4: Decryption")
#     while True:
#         remaining_time = check_timer(start_time)  # Check time here
#         print(f"Time left: {remaining_time:.2f} seconds")
...
#     p, q = stage1(start_time)
#     e, d, n = stage2(p, q, start_time)
#     ciphertext = stage3(e, n, start_time)
#     stage4(ciphertext, d, n, start_time)
...
# # LEVEL
# # first select level, if easy time dia 3 minute and range prime number (1-999), 
# # if medium time dia 2 minute and range prime number (1000-9999), if hard 1 minute and range prime number (10,000-999,999)
